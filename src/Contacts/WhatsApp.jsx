  ...
  return (
    ...
    >
      <BackBtn />
        ...
        <div className={`w-full md:max-w-[600px] md:h-[300px] m-3 rounded-lg flex items-center justify-center flex-col p-4 box-border ${isDark?"shadow-sm shadow-white":"shadow-lg"}`}>
        ...
        <div className={`w-full md:max-w-[600px] md:h-[300px] m-3 rounded-lg flex items-center justify-center p-4 box-border ${isDark?"shadow-sm shadow-white":"shadow-lg"}`}>

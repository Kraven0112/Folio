...
export default function AccessoryCard({image,title}) {
  ...
  return (
    <Link to={`/accessorydetail/${title}`} className={`block text-center rounded-2xl w-[320px] h-[340px] sm:w-[340px] sm:h-[410px] sm:p-1 ${isDark?"shadow-sm shadow-white":"shadow-lg"}`}>

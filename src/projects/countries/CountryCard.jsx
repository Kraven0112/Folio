...
export default function CountryCard({title,image,capital,continent,region}) {
  ...
  return (
    <Link to={`/country/${title}`} className={`block overflow-hidden rounded-2xl w-[full] marker sm:w-[340px] sm:h-[415px] hover:scale-[1] ${isDark?"shadow-sm shadow-white":"shadow-lg"}`}>
